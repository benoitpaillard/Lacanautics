...
self.addEventListener('fetch',e=>{
  ...
  const fresh=u.pathname.endsWith('.html')||u.pathname.endsWith('.json')||u.pathname.endsWith('.svg')||u.pathname.endsWith('.webp')||u.pathname.endsWith('/Lacanautics/')||u.pathname.endsWith('/Lacanautics');
  if(fresh){
